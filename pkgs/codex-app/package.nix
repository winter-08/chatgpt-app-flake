...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.707.62119/codex-app-linux-x64-v26.707.62119.AppImage";
    hash = "sha256-UNsXWWUMN098olyPz9RZoVv+ZHcS0nPdKb5nex6L5Lg=";
  };
