...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.707.51957/codex-app-linux-x64-v26.707.51957.AppImage";
    hash = "sha256-tsS9f1i6G1+u3HQMJ2A6ZNsb09SG0O379QCjiYOUhKk=";
  };
