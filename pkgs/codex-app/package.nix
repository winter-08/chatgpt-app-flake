...
let
  pname = "codex-app";
  version = "26.715.31927";

  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.715.31927/codex-app-linux-x64-v26.715.31927.AppImage";
    hash = "sha256-7wy8i5uAofkkMMEP5p0ueFV+GD59HZs103dqr4esGfA=";
  };
