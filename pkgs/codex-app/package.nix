...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.715.52143/codex-app-linux-x64-v26.715.52143.AppImage";
    hash = "sha256-ZbjizkHyVazRpdD1cluOfjSeDfwFjoK3pDT7pU4Ui9U=";
  };
