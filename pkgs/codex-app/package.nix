...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.715.21425/codex-app-linux-x64-v26.715.21425.AppImage";
    hash = "sha256-56fnfKI1mKzJ2GorgE8ee/5gE4NC7ZPacvoGq+kxb90=";
  };
