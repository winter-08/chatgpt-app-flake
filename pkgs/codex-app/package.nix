...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.721.30844/codex-app-linux-x64-v26.721.30844.AppImage";
    hash = "sha256-mL/JXALkcGwanarIhwtGuGcc+zZzl6QK3+1+xAPyLq0=";
  };
