...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.715.61943/codex-app-linux-x64-v26.715.61943.AppImage";
    hash = "sha256-OO73aoAdnJAQ8AjzwJj+clMxtKQeuLtcNE6VecndG9w=";
  };
