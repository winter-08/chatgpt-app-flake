...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.803.81509/codex-app-linux-x64-v26.803.81509.AppImage";
    hash = "sha256-ZfBfV5+4xRs7Uy/EdczNpbfe8tPn9B+CeaGAtGG/Pbs=";
  };
