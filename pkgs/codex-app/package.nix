...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.707.31428/codex-app-linux-x64-v26.707.31428.AppImage";
    hash = "sha256-2/S0DNR1x5VqILTJeuOfxU2nFcdzZOmm7QI5Y1eHWmI=";
  };
