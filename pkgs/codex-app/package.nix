...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.721.31836/codex-app-linux-x64-v26.721.31836.AppImage";
    hash = "sha256-FHWLUQQ6fFcsop9h5lPVX5dT/lZOU2I+soNOKw/FS10=";
  };
