...
let
  ...
  src = fetchurl {
    url = "https://github.com/am-will/codex-app/releases/download/v26.803.41515/codex-app-linux-x64-v26.803.41515.AppImage";
    hash = "sha256-77Q5JEZexVshHbWxYuaUFnYAR7Xo6SNqHGjstjj9A30=";
  };
